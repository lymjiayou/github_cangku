/**
 * Created by hui shi on 2019/8/12.
 */
var http=Http;
...
$(function () {
    ...
    //获取所有已取消订单
    $.ajax({
        url:http+"order?uid="+u_id+"&sid="+s_id+"&page=1&pageSize=10&state=0",
        type:"get",
    ...
    $("#search_time").click(function () {
        ...
        $.ajax({
            url:http+"order?uid="+u_id+"&page=1&pageSize=10&sid="+s_id+"&startTime="+start_time+"&endTime="+end_time+"&state=0",
            type:'get',
            xhrFields:{withCredentials: true},
...
function change_page(current_page) {
    ...
    //获取所有待发货订单
    $.ajax({
        url:http+"order?uid="+u_id+"&sid="+s_id+"&page="+current_page+"&pageSize=10&state=0",
        type:"get",
        xhrFields:{withCredentials: true},
        success:function (order_list) {
            if(order_list.msg=="SUCCESS"){
...
function change_time_page(time_current_page,start_time,end_time) {
    ...
    $.ajax({
        url:http+"order?uid="+u_id+"&page="+time_current_page+"&pageSize=10&sid="+s_id+"&startTime="+start_time+"&endTime="+end_time+"&state=0",
        type:"get",
        xhrFields:{withCredentials: true},
        success:function (order_list) {
            if(order_list.msg=="SUCCESS"){
