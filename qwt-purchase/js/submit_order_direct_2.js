...
//当点击按钮时，要通过最后一次验证表单内容是否符合规则，可通过。warn标签的长度来判断
    ...
    $("#new_ad").click(function () {
        ...
        $("#new_address_Modal").on('hide.bs.modal', function () {
            window.sessionStorage.pay= $('input:radio[name="pay"]:checked').val();
            window.sessionStorage.receipt=$("#no_receipt").is(":checked");
            window.sessionStorage.re_type = $("input:radio[name='re_type']:checked").val();
            window.sessionStorage.kai_type = $("input:radio[name='kai_type']:checked").val();
            window.sessionStorage.bankName = $(".choose_bank option:selected").val();
            window.sessionStorage.company_name = $(".company_name").val();
            window.sessionStorage.taxpayer = $(".tax_num").val();
            window.sessionStorage.companyAdress = $(".company_address").val();
            window.sessionStorage.companyTel = $(".company_tel").val();
            window.sessionStorage.bankAccount = $(".bank_account").val();
            window.sessionStorage.payremark = $(".buyer_message").val();
            console.log(window.sessionStorage.company_name)
            console.log(window.sessionStorage.companyTel)
            // window.location.reload();
        })
